...
NSE_FNO_STOCKS = [
    ...
    "TATAMOTORS","NTPC","POWERGRID","HCLTECH","ASIANPAINT","ULTRACEMCO","WIPRO",
    ...
    "SBILIFE","HDFCLIFE","BAJAJ_AUTO","DABUR","PIDILITIND","HAVELLS","SIEMENS",
    "GODREJCP","DLF","BANKBARODA","PNB","IDFCFIRSTB","FEDERALBNK","INDHOTEL",
    "TRENT","ZOMATO","JIOFIN","CANBK","RECLTD","PFC","NHPC","IOC","GAIL","BEL",
    "HAL","BHEL","IRCTC","IRFC","IDEA","SAIL","NMDC","NATIONALUM","HINDPETRO",
    "PETRONET","MUTHOOTFIN","M_MFIN","L_TFH","MANAPPURAM","ABCAPITAL","LICHSGFIN",
    ...
    "ADANIENSOL","TORNTPOWER","CUMMINSIND","ABB","CROMPTON","VOLTAS","BLUESTARLT",
    "DIXON","DEEPAKNTR","ATUL","PIIND","UPL","COROMANDEL","GNFC","CHAMBALFERT",
    "RAIN","TATACOMM","CENTURYTEX","BALRAMCHIN","ESCORTS","ASHOKLEY","EXIDEIND",
    "AMARAJABAT","BALKRISIND","APOLLOTYRE","MGL","IGL","GUJGASLTD","CONCOR",
    "GMRAIRPORT","IRCON","RVNL","NBCC","OBEROIRLTY","GODREJPROP","PRESTIGE",
    "BRIGADE","PHOENIXLTD","SUNTV","PVRINOX","NETWORK18","TV18BRDCST","ZEEL",
    ...
    "NAVINFLUO","FLUOROCHEM","GRINDWELL","CAMS","CDSL","BSE","MCX","ANGEL",
    "MOTILALOFS","MFSL","ISEC"
]

NSE_NON_FNO_STOCKS = [
    "YESBANK","TRIDENT","SOUTHBANK","CENTRALBK","MAHABANK","UNIONBANK","IOB",
    "UCOBANK","PSB","J_KISOL","IBREALEST","RPOWER","JPPOWER","JPASSOCIAT",
    "GTLINFRA","INTELLECT","TANLA","AGARIND","ORIENTELEC","VTL","GPPL","MAHLIFE",
    "KRBL","EIHOTEL","LAXMIMACH","GREAVESCOT","HEIDELBERG","ORIENTCEM","SAGCEM",
    "HIL","NILKAMAL","TDPOWERSYS","TIINDIA","GALAXYSURF","FINEORG","VINDHYATEL",
    "DBCORP","JAGRAN","NAVNETEDUL","EPL","JMFINANCIL","EDELWEISS","KFINTECH",
    "CMSINFO","NIACL","GICRE","SOLARINDS","THERMAX","ELGIEQUIP","TIMKEN",
    "SCHAEFFLER","SKFINDIA","ENDURANCE","FIVESTAR","CREDITACC","MASFIN","EQUITAS",
    ...
    "HUDCO","IREDA","IIFL","POONAWALLA","KAYNES","DATAPATTNS","LATENTVIEW",
    "MASTEK","NEWGEN","BSOFT","ZENSAR","BIRLASOFT","CYIENT","ECLERX","CESC",
    "JSWENERGY","KPIL","KALPATPOWR","RITES","ENGINERSIN","HEG","GRAPHITE",
    "WABAG","VGUARD","BASF","BAYER","FDC","CAMPUS","METROBRAND","GOKALDAS",
    "SWANENERGY","PCBL","TTKPRESTIG","HAWKINCOOK","SAFARI","VMART","SHOPERSTOP",
    "DEVYANI","JUBLFOOD","JYOTHYLAB","HINDWARE","OLECTRA","EASEMYTRIP","IXIGO",
    "RATEGAIN","MEDPLUS","RAINBOW","NH","YATHARTH","GLOBALHEAL","MANKIND","PGHH",
    "GILLETTE","3MINDIA","HONAUT","CARBORUNIV","SUPRAJIT","SUMICHEM","BECTORFOOD",
    "HATSUN","HERITGFOOD","DODLA","PARAG","MAHSEAMLES","WELCORP","JINDALSAW",
    "MIDHANI","MISHRA","COCHINSHIP","MAZAGONDOC","GRSE","GARDENREACH","BEML",
    "TITAGARH","DHANUKA","BAYERCROP","RALLIS","GODREJAGRO","FACT","RCF","GSFC","SPIC"
]
